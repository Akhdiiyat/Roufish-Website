...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container-fluid">
          <a class="navbar-brand me-auto" href="#"><img src="assets/image/Roufish.png" alt="logo roufish" width="60px"></a>
          <div
          ...
          >
            <div class="offcanvas-header">
              <h5 class="offcanvas-title" id="offcanvasNavbarLabel" ><img src="assets/image/Roufish.png" alt="logo roufish" width="60px"></h5>
              <button
                type="button"
                class="btn-close"
